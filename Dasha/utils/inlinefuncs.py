...
from Dasha import arq
from Dasha.services.keyboard import Ikb
from Dasha.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from Dasha.services.tasks import _get_tasks_text, all_tasks, rm_task
from Dasha.services.types import InlineQueryResultCachedDocument
from Dasha.modules.info import get_chat_info, get_user_info
from Dasha.utils.functions import test_speedtest
from Dasha.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/Dashaxbot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Dasha ❤️](https://t.me/machinaxsupport):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
