...
def get_user_list(__init__, key):
    with open("{}/Dasha/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[Dasha] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[Dasha]')
LOGGER.info("Dasha is starting. | An lalrochhara Project Parts. | Licensed under GPLv3.")
...
if ENV:
    ...
    from Dasha.config import Development as Config
...
from Dasha.modules.helper_funcs.handlers import (
