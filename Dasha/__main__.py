...
import Dasha.modules.sql.users_sql as sql
...
from Dasha.modules import ALL_MODULES
from Dasha.modules.helper_funcs.chat_status import is_user_admin
from Dasha.modules.helper_funcs.misc import paginate_modules
...
from Dasha.modules.language import gs
...
Dasha_IMG = "https://firebasestorage.googleapis.com/v0/b/baby-bawitlung-story.appspot.com/o/Image%20file%2FNew%20pp%20fid.png?alt=media&token=2df32c52-8095-4227-80d2-2a1ca822a7a6"
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Dasha.modules." + module_name)
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(text=gs(chat.id, "about_button"), callback_data="Dasha_"),
                        ],
                        [
...
def Dasha_about_callback(update, context):
    query = update.callback_query
    chat = update.effective_chat
    if query.data == "Dasha_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="Admins", callback_data="Dasha_admin"),
                        InlineKeyboardButton(text=gs(chat.id, "notes_button"), callback_data="Dasha_notes"),
                    ],
                    [
                        InlineKeyboardButton(text=gs(chat.id, "support_chat_link_button"), callback_data="Dasha_support"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="Vain", url="https://github.com/lalrochhara"),
                    ],
                    [
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        Dasha_about_callback, pattern=r"Dasha_", run_async=True
    )
