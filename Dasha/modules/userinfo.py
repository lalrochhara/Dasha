...
from Dasha.__main__ import STATS, TOKEN, USER_INFO
from Dasha.modules.sql import SESSION
import Dasha.modules.sql.userinfo_sql as sql
from Dasha.modules.disable import DisableAbleCommandHandler
from Dasha.modules.sql.global_bans_sql import is_user_gbanned
from Dasha.modules.sql.afk_sql import is_afk, set_afk
from Dasha.modules.sql.users_sql import get_user_num_chats
from Dasha.modules.helper_funcs.chat_status import sudo_plus
from Dasha.modules.helper_funcs.extraction import extract_user
from Dasha import telethn
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current Dasha Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
    result = re.sub(r"(\d+)", r"<code>\1</code>", stats)
    result += "\n<b>╘═━「 Powered By lalrochhara 」</b>"
    update.effective_message.reply_text(
        result,
        parse_mode=ParseMode.HTML, 
        disable_web_page_preview=True
