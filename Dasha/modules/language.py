import itertools
import Dasha.modules.sql.language_sql as sql
...
from Dasha.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from Dasha.language import get_string, get_languages, get_language
    ...
    keyb.append(
        [
            InlineKeyboardButton(
                ...
                url="https://localazy.com/p/dasha-translations-project",
            )
        ]
    )
