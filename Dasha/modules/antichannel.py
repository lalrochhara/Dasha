...
from Dasha.modules.helper_funcs.decorators import Dashacmd, Dashamsg
from Dasha.modules.helper_funcs.channel_mode import user_admin, AdminPerms
from Dasha.modules.sql.antichannel_sql import antichannel_status, disable_antichannel, enable_antichannel
from Dasha.modules.language import gs

@Dashacmd(command="antichannelmode", group=100)
...
@Dashamsg(Filters.chat_type.groups, group=110)
