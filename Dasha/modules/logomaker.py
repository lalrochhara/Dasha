...
from Dasha import telethn as tbot, ubot2
...
async def logo_gen(event):
    ...
    if event.reply_to_msg_id:
        ...
        fpath_ = glob.glob("./Dasha/resources/fonts/*")
    ...
    if os.path.exists(flnme):
        await tbot.send_file(
            event.chat_id,
            file=flnme,
            caption="Logo by [Dasha](https://t.me/Dashaxbot)",
    ...
    if os.path.exists(font_):
        if not font_.startswith("./Dasha/resources/fonts"):
            os.remove(font_)
